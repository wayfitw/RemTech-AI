...
class TelegramBot:
    ...
    async def _dispatch_message(self, chat_id, frm, tg_id, text,
        ...
        if text in ("/start", "/help"):
            ...
            if text == "/help":
                msg = (
                    "<b>Ваш личный ИИ-ассистент.</b>\n\n"
                    "<b>Что я умею:</b>\n"
                    "📄 <b>Документы</b> — КП, сметы, договоры, презентации (Word/PDF/Excel/PPTX)\n"
                    "🔍 <b>Анализ материалов</b> — договоры, презентации, переписки и звонки, фото\n"
                    "🎨 <b>Генерация медиа</b> — изображения и видео\n"
                    "📧 <b>Почта и чаты</b> — письма, сводки по Telegram-группам\n"
                    "⏰ <b>Напоминания</b> — с сигналами заранее\n"
                    "📈 <b>Тендеры</b> — поиск и анализ закупок на ЕИС\n"
                    "📰 <b>Новости ИИ и погода</b> — свежие сводки\n"
                    "🌐 <b>Веб-поиск</b> и база знаний компании\n\n"
                    "/new — начать новый диалог.\n\n"
                    "Возникли проблемы или вопросы по работе бота — напишите @dima_garnov."
                )
            else:  # /start — короткое приглашение начать
                msg = (f"Здравствуйте, {esc(name)}! 👋\n\n"
                       "Можете начинать — просто напишите вопрос или задачу "
                       "(можно голосом), и я подключусь.\n\n"
                       "/help — что я умею · /new — новый диалог")
